...
public class FontUtills {
    ...
    public FontUtills(Object font) {
        this(font, 18F);
    }

    public FontUtills(Object font, float size) {
        this.fontSize = size;
        this.startChar = 32;
        this.endChar = 255;
    ...
    public final void drawString(MatrixStack matrixStack, String text, float x, float y, FontType fontType, int color) {
        ...
        drawString(matrixStack, text, x, y, fontType, color, MiscUtills.modify(o, 0, 0, 0, Math.min(0xBB, o.getAlpha())).getRGB());
